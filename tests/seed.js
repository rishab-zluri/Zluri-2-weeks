...
const pool = new Pool({
  ...
  port: parseInt(process.env.PORTAL_DB_PORT || process.env.DB_PORT, 10) || 5432,
  database: process.env.PORTAL_DB_NAME || process.env.DB_NAME || 'db_query_portal',
  user: process.env.PORTAL_DB_USER || process.env.DB_USER || 'postgres',
